...
function displaystraw() {
  if(i<5){
  total +=num2
  document.getElementById("demo2").innerHTML = "STRAWBERRY.........100";
  var  box = document.getElementById("box")
  var layer = document.createElement('div')
...
function displaybutter() {
  if(i<5){
  total +=num3
  document.getElementById("demo3").innerHTML = "BUTTERSCOTCH....200";
  var  box = document.getElementById("box")
  var layer = document.createElement('div')
...
function displayvan() {
  if(i<5){
  total +=num4
    document.getElementById("demo4").innerHTML = "VANNILLA................250";
    var box= document.getElementById("box")
  var layer = document.createElement('div')
...
function displayred() {
  if(i<5){
  total +=num5
    document.getElementById("demo5").innerHTML = "REDVELVET.............350";
    var  box = document.getElementById("box")
  var layer = document.createElement('div')
...
function displayimg() {
    document.getElementById("demo6").innerHTML = "TOTAL AMOUNT" + total;
    var img=new Image()
